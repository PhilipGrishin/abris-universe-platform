...
for (const requiredPath of [
  ...
  "apps/web/index.html",
  "apps/web/accessibility.html",
  "apps/web/benchmark.html",
  "apps/web/browser-failure.html",
  "apps/web/src/App.tsx",
  "apps/web/src/accessibility-main.tsx",
  "apps/web/src/benchmark-main.ts",
  "apps/web/src/browser-failure-main.ts",
  "apps/web/src/engineering-evidence.ts",
  "apps/web/src/engineering-evidence-output.tsx",
  "apps/web/src/glyph-atlas.ts",
  "apps/web/src/import-client.ts",
  "apps/web/src/import.worker.ts",
  "apps/web/src/main.tsx",
  "apps/web/src/messages.ts",
  "apps/web/src/project-service.ts",
  "apps/web/src/render-worker-client.ts",
  "apps/web/src/render-worker-cache.ts",
  "apps/web/src/render.worker.ts",
