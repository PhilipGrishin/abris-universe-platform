...
| TRACE-SECURITY-TS001 | Bound untrusted OXS processing and preserve local-only privacy | TASK-THINSLICE-001 sections 22/23/27 | Technical Design section 7; `docs/assurance/threat-models/TASK-THINSLICE-001_THREAT_MODEL.md` | Threat model `[PROPOSED]`; AU-AGENT-003 review and control evidence `[OPEN]` |
