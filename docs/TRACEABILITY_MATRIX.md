...
| TRACE-DESIGN-TS001 | Complete the TASK-THINSLICE-001 Technical Design and architecture review before development | TASK-THINSLICE-001 v1.1; PROD-DEC-009; Technical Review | `docs/TASKS.md`, `.codex/CURRENT_FOCUS.md`; future Technical Design Proposal and ADR dispositions | `[OPEN]`; next gate |
