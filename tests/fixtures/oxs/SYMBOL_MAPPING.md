...
Route-1 symbol evidence is complete and can support deterministic importer
tests. TD-GATE-002 remains `[OPEN]` for exact-symbol claims about other producer
profiles. Unknown numeric codes, proprietary fonts, or cross-palette
collisions must use the Technical Design warning and deterministic fallback
rules rather than an invented glyph mapping.
